...
//================================================================================
//================================================================================
SET_SCHEDULE_TASKS( CCaptureGhostSchedule )
{
    bool carefulApproach = GetDecision()->ShouldMustBeCareful();

    ADD_TASK( BTASK_SET_FAIL_SCHEDULE, SCHEDULE_COVER );
    ADD_TASK( BTASK_PICKUP_GHOST, NULL );
    ADD_TASK( BTASK_DELIVER_GHOST, NULL );
}


SET_SCHEDULE_INTERRUPTS( CCaptureGhostSchedule )
{
...
//================================================================================
//================================================================================
float CCaptureGhostSchedule::GetDesire() const
{
    if (!GetLocomotion())
    { // can't move
